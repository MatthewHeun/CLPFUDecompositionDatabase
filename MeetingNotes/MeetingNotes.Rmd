...
- [x] MKH: Send Zeus vignettes for matsindf and matsbyname packages.
...
Zeus started the analysis with a toy model.
Next step is working with the actual data Matt sent.
...
- [ ] MKH: Move one function from PFUPipeline2 to new PFUAnalysisTools package.
           Make sure the pipeline still works.
- [ ] ZG: Visualize efficiency results sent by MKH.
- [x] MKH: Send Final Energy from two countries and two years to Zeus.
           Later, we will be able to send more countries, more years, 
           and useful, and exergy.
- [x] MKH: Send Zeus examples of allocation and efficiency matrices
...
- EA: Economic and indicators dataset from IEA.
      Which one does ZG need?
